...
INSERT INTO gejala (id_penyakit, deskripsi) VALUES
  (@p1, 'Daun gugur'),
  (@p1, 'Daun kering'),
  (@p1, 'Permukaan kulit buah terdapat titik-titik hitam'),
  (@p1, 'Daun berlubang'),
  (@p1, 'Daun berupa bercak tidak teratur'),
  (@p1, 'Daun berwarna coklat keabuan'),
  (@p1, 'Batang muda berupa bercak coklat keabuan'),
  (@p1, 'Batang terdapat bercak membentuk gelang melingkari batang'),
  (@p1, 'Batang mati'),
  (@p1, 'Bunga terlihat bintik-bintik kecil'),
  (@p1, 'Daging buah busuk'),
  (@p1, 'Bunga gugur/rontok');
...
-- P007 Bercak Daun Kelabu
INSERT INTO penyakit (nama) VALUES ('Bercak Daun Kelabu');
SET @p7 = LAST_INSERT_ID();
INSERT INTO gejala (id_penyakit, deskripsi) VALUES
  (@p7, 'Daun gugur'),
  (@p7, 'Daun berlubang'),
  (@p7, 'Daun muda berupa bercak putih keabuan'),
  (@p7, 'Daun dapat membentuk bercak yang besar'),
